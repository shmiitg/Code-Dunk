            ...
            <div className={classes["profile-edit-card"]}>
                ...
                <div className={classes["col"]}>
                    ...
                    <div className={classes["type-1"]}>
                        ...
                        <input type="text" placeholder='Education' name="education" onChange={handleInput} value={user.education} />
                    </div>
                    <div className={classes["type-1"]}>
                        <div className={classes["col-placeholder"]}>gender</div>
                        <select name="gender" onChange={handleInput}>
                            <option value="" selected={user.country === 'Your gender'}>--Your Gender--</option>
