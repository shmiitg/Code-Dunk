...
const ReadInterview = () => {
    ...
    const fetchInterview = async () => {
        const res = await axios.get(`/api/interview/read/${id}`);
        ...
        <div className="container">
            <div className="read-interview-container">
                ...
                <div className="read-interview-info">
                    <div className="read-interview-author"><Link to={`/profile/dashboard?user=${interview.author}`}>{interview.author}</Link></div>
